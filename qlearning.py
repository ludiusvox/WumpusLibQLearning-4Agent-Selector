...
@author: Asus
@author: Revised by Aaron Linder
"""
...
print("Start (#, #) range 0-4")
start = tuple((eval((input()) )))
print("Hole 1 (#, #) range 0-4")
hole1 = tuple((eval((input()) )))
print("Hole 2 (#, #) range 0-4")
hole2 = tuple((eval((input()) ))) #hole2 point
print("Pit (#, #) range 0-4")
wall = tuple((eval((input()) )))#wall point
print("Gold (#, #) range 0-4")
gold = tuple((eval((input()) )))#gold point
print("Exit (#, #) range 0-4")
goal = tuple((eval((input()) ))) #goal point
...
# =============================================================================
class Q_Learning:
    def __init__(self, environment_rows, environment_columns, start, hole1, hole2, wall, gold, goal, episodes, epsilon, discount_factor):
    ...
    def set_matrices(self):
        ...
        self.rewards[self.goal] = self.rewards[self.gold]= 100
...
Q_L = Q_Learning(environment_rows, environment_columns, start, hole1, hole2, wall, gold, goal, episodes, epsilon, discount_factor)
Q_L.set_matrices()
...
print("here you can see the reward output for losing and the how the machine learns")
print(Q_L.rewards)
print("Follow these coordinates for the optimal path after model trained")
